...
**Meme Galaxy** is a single-page app built using React JS and Vite whose aim is to display different memes with differenct categories accodrding to data fetched from <b>imgflip API.</b> For more information visit the <a href="https://drive.google.com/file/d/1eZNRTECZUpxfykamc0erwobgSFsP5tY5/view?usp=sharing">video presentation</a>
...
**`git clone https://github.com/MarwanDev/Meme-Galaxy.git**
...
Feel free to check the [issues page](https://github.com/MarwanDev/meme-galaxy/issues).
...
- Thanks to Nelson Sakwa on Behance for his great design.
...
This project is [MIT](https://github.com/MarwanDev/Meme-Galaxy/blob/development/LICENSE) licensed.
